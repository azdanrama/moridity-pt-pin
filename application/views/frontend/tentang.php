...
<section class="section-sm feature-2">
	<div class="container">
		<div class="row align-items-center">
			<div class="col-lg-5">
				<div class="about-us">
					<!-- <span class="text-color">Tentang Kami</span> -->
					<h2>Tentang MoriDity</h2>
				</div>
			</div>
			<div class="col-lg-7">
						...
						<div class="carousel-inner mt-4">
							<div class="carousel-item text-center active">
								<div class="img-box p-1 border rounded-circle m-auto">
									<img src="<?=base_url('assets');?>/images/team/Tia.png" alt="" class="d-block w-100 rounded-circle">
								</div>
								...
								<ul class="list-inline">
									...
									<li class="list-inline-item"><a href="https://www.instagram.com/tiazahroni10/"><i class="ti-instagram"></i></a></li>
									<li class="list-inline-item"><a href="https://www.linkedin.com/in/tiazahroni/"><i class="ti-linkedin"></i></a></li>
								</ul>
							</div>
							<div class="carousel-item text-center">
								<div class="img-box p-1 border rounded-circle m-auto">
									<img src="<?=base_url('assets');?>/images/team/Ageng.png" alt="" class="d-block w-100 rounded-circle">
								</div>
								...
								<ul class="list-inline">
									...
									<li class="list-inline-item"><a href="https://www.instagram.com/agengayuu/"><i class="ti-instagram"></i></a></li>
									<li class="list-inline-item"><a href="https://www.linkedin.com/in/ageng-ayu-121699225/"><i class="ti-linkedin"></i></a></li>
								</ul>
							</div>
							<div class="carousel-item text-center">
								<div class="img-box p-1 border rounded-circle m-auto">
								...
								<ul class="list-inline">
									...
									<li class="list-inline-item"><a href="https://www.instagram.com/psyaf_/"><i class="ti-instagram"></i></a></li>
									<li class="list-inline-item"><a href="https://www.linkedin.com/in/adilla-permata-safira-703748223/"><i class="ti-linkedin"></i></a></li>
								</ul>
							</div>
							<div class="carousel-item text-center">
								<div class="img-box p-1 border rounded-circle m-auto">
								...
								<ul class="list-inline">
									...
									<li class="list-inline-item"><a href="https://www.instagram.com/azdanrama/"><i class="ti-instagram"></i></a></li>
									<li class="list-inline-item"><a href="https://www.linkedin.com/in/azdanrama/"><i class="ti-linkedin"></i></a></li>
								</ul>
							</div>
							<div class="carousel-item text-center">
								<div class="img-box p-1 border rounded-circle m-auto">
								...
								<ul class="list-inline">
									...
									<li class="list-inline-item"><a href="https://www.instagram.com/ryokuzo9/"><i class="ti-instagram"></i></a></li>
									<li class="list-inline-item"><a href="<?=base_url()?>#"><i class="ti-linkedin"></i></a></li>
								</ul>
							</div>
						</div>
