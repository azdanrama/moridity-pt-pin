...
<head>
    ...
    <link href='././assets/images/admin/logomoridity.png' rel="shortcut icon">
</head>
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="<?= base_url(); ?>Home_admin" class="brand-logo">
                        ...
                        <ul class="navbar-nav header-right">
                                            ...
                                            <li>
                                                <div class="timeline-panel">
                                                    <div class="media mr-2">
                                                        <img alt="image" width="50" src="<?= base_url('assets'); ?>images/admin/avatar/1.jpg">
                                                    </div>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    <img src="<?= base_url('assets'); ?>/images/admin/profile/17.jpg" width="20" alt="" />
