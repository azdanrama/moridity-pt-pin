...
class Moridata_admin extends CI_Controller {
	...
	{
		$moridata	= $this->Admin_moridata_m->getData();
	...
	{
		$data['data_komoditas_kelor_general']	= $this->Admin_moridata_m->getDataUser();
		$data['user']				= $this->Admin_moridata_m->getAvatar()->result();
	...
	{
		$data['user']	= $this->Admin_moridata_m>getuser()->result();
		$this->load->view('admin/layouts/header', $data);
		$this->load->view('admin/layouts/sidebar');
		$this->load->view('admin/moridata/create', $data);
		$this->load->view('admin/layouts/footer');
	}
	...
	public function edit($id)
	{
		...
		$data['komoditas_kelor']	= $this->Admin_moridata_m->editData($where, 'data_komoditas_kelor')->result();
		$data['user']				= $this->Admin_moridata_m->getAvatar()->result();
		$this->load->view('admin/layouts/header', $data);
		$this->load->view('admin/layouts/sidebar');
		$this->load->view('admin/moridata/edit', $data);
		$this->load->view('admin/layouts/footer');
	...
	public function update()
	{
		...
		$this->Admin_moridata_m->updateData($where, $data, 'data_komoditas_kelor');
		redirect('moridata/index');
	}
	...
	{
		$where	= array('id_datakelor' => $id);
		$this->Admin_moridata_m->deleteData($where, 'data_komoditas_kelor');
		redirect('moridata/index');
	}
	...
	public function exportpdf(){
		...
		$html			= $this->load->view('admin/moridata/mori_pdf', $data, true);
